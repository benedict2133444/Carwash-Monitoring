 ...
 *
 * IMPORTANT:
 * When LV_SCR_LOAD_ANIM_NONE is requested, load the screen
 * directly instead of using lv_scr_load_anim().
 *
 * This avoids unnecessary animation/redraw processing on the
 * RGB display when buttons are pressed.
 */
void _ui_screen_change(lv_obj_t ** target, lv_scr_load_anim_t fademode, int spd, int delay, void (*target_init)(void))
{
    ...
    /*
     * For LV_SCR_LOAD_ANIM_NONE, load the screen directly.
     * This avoids unnecessary animation processing and redraws.
     */
...
{
    screen_destroy_cb_t destroy_cb =
...
void _ui_anim_callback_free_user_data(
    lv_anim_t * a
)
{
    lv_mem_free(
...
void _ui_anim_callback_set_x(
    lv_anim_t * a,
    int32_t v
)
{
    ui_anim_user_data_t * usr =
        (ui_anim_user_data_t *)a->user_data;
...
void _ui_anim_callback_set_width(
    lv_anim_t * a,
    int32_t v
)
{
...
void _ui_anim_callback_set_height(
    lv_anim_t * a,
    int32_t v
)
{
...
void _ui_anim_callback_set_opacity(
    lv_anim_t * a,
    int32_t v
)
{
...
void _ui_anim_callback_set_image_zoom(
    lv_anim_t * a,
    int32_t v
)
{
...
void _ui_anim_callback_set_image_angle(
    lv_anim_t * a,
    int32_t v
)
{
...
void _ui_anim_callback_set_image_frame(
    lv_anim_t * a,
    int32_t v
)
{
...
int32_t _ui_anim_callback_get_x(
    lv_anim_t * a
)
{
    ui_anim_user_data_t * usr =
...
int32_t _ui_anim_callback_get_y(
    lv_anim_t * a
)
{
    ui_anim_user_data_t * usr =
    ...
    return lv_obj_get_y_aligned(
        usr->target
    );
}


int32_t _ui_anim_callback_get_width(
    lv_anim_t * a
)
{
    ui_anim_user_data_t * usr =
    ...
    return lv_obj_get_width(
        usr->target
    );
}


int32_t _ui_anim_callback_get_height(
    lv_anim_t * a
)
{
    ui_anim_user_data_t * usr =
    ...
    return lv_obj_get_height(
        usr->target
    );
}


int32_t _ui_anim_callback_get_opacity(
    lv_anim_t * a
)
{
    ui_anim_user_data_t * usr =
...
int32_t _ui_anim_callback_get_image_zoom(
    lv_anim_t * a
)
{
    ui_anim_user_data_t * usr =
    ...
    return lv_img_get_zoom(
        usr->target
    );
}


int32_t _ui_anim_callback_get_image_angle(
    lv_anim_t * a
)
{
    ui_anim_user_data_t * usr =
    ...
    return lv_img_get_angle(
        usr->target
    );
}


int32_t _ui_anim_callback_get_image_frame(
    lv_anim_t * a
)
{
    ui_anim_user_data_t * usr =
...
void _ui_slider_set_text_value(
    lv_obj_t * trg,
    lv_obj_t * src,
    const char * prefix,
    const char * postfix
...
void _ui_checked_set_text_value(
    lv_obj_t * trg,
    lv_obj_t * src,
    const char * txt_on,
    const char * txt_off
